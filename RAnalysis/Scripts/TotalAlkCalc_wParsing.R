...
setwd("~/MyProjects/Geoduck_Epi/project_larval_geoduck_OA/RAnalysis/")
main<-getwd()
...
massfile<-"20180710mass_Run2.csv" # name of your file with masses
titrationfile<-'20180710_Run2.csv'# name of the last titration file run
