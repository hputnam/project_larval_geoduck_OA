...
#############################################################
setwd("~/MyProjects/Geoduck_Epi/project_larval_geoduck_OA/RAnalysis/Data") #set working directory
mainDir<-'~/MyProjects/Geoduck_Epi/project_larval_geoduck_OA/RAnalysis/' #set main directory
#############################################################


##### DISCRETE pH CALCULATIONS #####
path <-("~/MyProjects/Geoduck_Epi/project_larval_geoduck_OA/RAnalysis/Data/pH_Calibration_Files/")
...
daily <- read.csv("SW_Chem_Trial2.csv", header=TRUE, sep=",", na.strings="NA") #load data with a header, separated by commas, with NA as NA
...
pdf("~/MyProjects/Geoduck_Epi/project_larval_geoduck_OA/RAnalysis/Output/Daily_Treatment_Measures.pdf")
par(mfrow=c(3,2))
...
pdf("~/MyProjects/Geoduck_Epi/project_larval_geoduck_OA/RAnalysis/Output/Daily_Tank_Measures.pdf")
par(mfrow=c(3,2))
...
write.table(carb.output, "~/MyProjects/Geoduck_Epi/project_larval_geoduck_OA/RAnalysis/Output/Seawater_chemistry_table_Output_All.csv", sep=",", row.names = FALSE) #save data
...
pdf("~/MyProjects/Geoduck_Epi/project_larval_geoduck_OA/RAnalysis/Output/Water_Chem_withTA.pdf")
par(mfrow=c(3,2))
plot(carb.output$Treatment, carb.output$Temperature, xlab="Treatment", ylab="Temperature°C", ylim=c(11,15))
plot(carb.output$Treatment, carb.output$pH, xlab="Treatment", ylab="pH Total Scale", ylim=c(7.0,8.0))
plot(carb.output$Treatment, carb.output$pCO2, xlab="Treatment", ylab="pCO2 µmol kg-1", ylim=c(350,6000))
plot(carb.output$Treatment, carb.output$Salinity, xlab="Treatment", ylab="Salinity psu", ylim=c(26,28))
plot(carb.output$Treatment, carb.output$TA, xlab="Treatment", ylab="Total Alkalinity µmol kg-1", ylim=c(2100,3000))
